...
\
Od wersji 1.15 farmy zero tickowe zostały naprawione przez Mojang, więc nie jest to możliwe na nowszych paczkach. Mimo to działają na wcześniejszej wersji - pakiecie Kwadratowa Masakra 1.0 z września 2019.\
W celu jego instalacji należy zalogować się do panelu, wyłączyć serwer, przejść do zakładki `ustawienia`, następnie `silniki` i wybrać pakiet `KM 2019.09 - 1.0`, kliknąć zapisz i włączyć serwer.\
