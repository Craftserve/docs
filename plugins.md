...
**Panel Craftserve** co prawda posiada zakładkę automatycznej instalacji pluginów, jednak funkcja ta, nie działa najlepiej. Instalacja często _**nie dobiega do końca**_, a jeśli już się to uda, to zainstalowana wersja pluginu _**nie jest obsługiwana**_ przez dany silnik.
...
![Folder plugins](.gitbook/assets/plugins.png)
